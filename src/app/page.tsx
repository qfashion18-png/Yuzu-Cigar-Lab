  ...
  return (
    <div className="relative overflow-hidden rounded-md border border-yuzu-gold/45 bg-yuzu-forest/90 shadow-[0_26px_70px_rgba(0,0,0,0.48)] backdrop-blur-md">
      ...
      <div className="relative">
        <div className="grid grid-cols-3 border-b border-yuzu-gold/25">
          {humidorReadings.map((reading) => {
            const Icon = reading.icon;
            return (
              <div key={reading.label} className="min-w-0 border-r border-yuzu-gold/20 px-2 py-2 last:border-r-0 sm:px-4 sm:py-3">
  ...
  return (
    <>
        ...
        <div className="mx-auto grid max-w-[1760px] lg:min-h-[560px] lg:grid-cols-[minmax(0,0.44fr)_minmax(0,0.56fr)]">
          <div className="relative z-10 flex items-center bg-[radial-gradient(circle_at_0%_15%,rgba(31,84,56,0.32),transparent_24rem),linear-gradient(90deg,#06120d_0%,#06120d_72%,rgba(6,18,13,0.92)_100%)] px-5 py-12 sm:px-8 lg:min-h-[560px] lg:px-10">
            ...
            <div className="mt-7 flex flex-col gap-3 sm:flex-row">
              ...
              <Button className="h-12 border-yuzu-gold px-8 text-yuzu-gold hover:bg-yuzu-gold hover:text-yuzu-ink" variant="outline" render={<Link href="/humidor" />}>
                <LockKeyhole data-icon="inline-start" />
                <span data-yuzu-editable="home.hero.secondaryCta">Explore Humidor</span>
              </Button>
            </div>
            <div className="mt-8 hidden gap-x-5 gap-y-4 sm:grid sm:grid-cols-2 xl:grid-cols-4">
              {heroProof.map((item) => {
                const Icon = item.icon;
                return (
                  <div key={item.label} className="flex min-w-0 items-start gap-3 border-yuzu-line/70 py-3 xl:border-r xl:pr-4 last:xl:border-r-0">
      ...
      <section data-home-cigar-flow="feature" className="mx-auto max-w-[1520px] px-5 pt-10 lg:px-10">
        <div className="overflow-hidden rounded-md border border-yuzu-line bg-[radial-gradient(circle_at_8%_8%,rgba(220,169,58,0.13),transparent_25rem),linear-gradient(135deg,rgba(8,19,14,0.98)_0%,rgba(4,9,7,0.98)_48%,rgba(16,33,24,0.92)_100%)] shadow-[0_24px_70px_rgba(0,0,0,0.22)]">
            ...
            <div className="flex flex-col justify-center p-6 sm:p-8 lg:p-10">
              ...
              <div className="mt-7 grid gap-3 sm:grid-cols-3">
                {cigarFlowStats.map((stat) => (
                  <div key={stat.label} className="border border-yuzu-line/75 bg-yuzu-night/48 p-4">
      ...
      <section data-home-events="featured" className="mx-auto grid max-w-[1520px] gap-0 px-5 pt-10 lg:grid-cols-[0.92fr_1.08fr] lg:px-10">
        <div className="relative min-h-[22rem] border border-yuzu-line/80 bg-yuzu-ink lg:min-h-[30rem] lg:border-r-0">
          <ReferenceImage
        ...
        <div className="grid content-start gap-4 lg:grid-cols-1">
          <Card className="luxury-card">
            ...
            <CardContent className="grid gap-3">
              {tiers.map((tier) => (
                <div key={tier.name} className="grid grid-cols-[1fr_auto] items-center gap-4 border border-yuzu-line/65 bg-yuzu-night/50 p-4">
                  <div>
      ...
      <section id="member-experience" data-home-member-platform="experience" className="mx-auto max-w-[1520px] px-5 py-14 lg:px-10">
        <div className="overflow-hidden rounded-md border border-yuzu-line bg-[radial-gradient(circle_at_12%_0%,rgba(220,169,58,0.14),transparent_26rem),linear-gradient(135deg,rgba(16,24,18,0.98)_0%,rgba(7,17,13,0.98)_48%,rgba(10,28,20,0.9)_100%)] shadow-[0_24px_70px_rgba(0,0,0,0.22)]">
          <div className="grid lg:grid-cols-[0.86fr_1.14fr]">
            ...
            <div className="grid gap-px bg-yuzu-line/55 sm:grid-cols-2">
              {memberPlatformHighlights.map((item, index) => {
                const Icon = item.icon;

                return (
                  <div key={item.title} className="min-h-56 bg-yuzu-night/60 p-5 transition hover:bg-yuzu-forest/80 lg:p-6">
        ...
        <div className="mx-auto grid max-w-[1520px] gap-8 px-5 py-14 lg:grid-cols-[0.8fr_1.2fr] lg:px-10">
          <div className="flex flex-col gap-5">
            <SectionHeading
              ...
              title="Live inventory first. QR and sensors after the API routes."
              copy="Version one reads and writes Cognito-protected humidor item records through the Yuzu API, including aging dates, ratings, tasting notes, and reorder reminders."
            />
            <Card className="luxury-card max-w-xl">
              ...
              <CardContent className="grid gap-3 text-sm leading-6 text-yuzu-muted">
                <p>Member humidor data requires Cognito and flows through the live Yuzu API.</p>
                <p>No browser-seeded cigar, climate, or smoke-log data is shown in production.</p>
              </CardContent>
            </Card>
          ...
          <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {humidorFeatureList.map((feature) => {
              ...
              return (
                <div key={feature.title} className="flex items-center gap-3 border border-yuzu-line bg-yuzu-night/50 p-4">

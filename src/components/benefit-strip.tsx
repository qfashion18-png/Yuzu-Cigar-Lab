...
export function BenefitStrip() {
  return (
    <section className="border-y border-yuzu-line/70 bg-yuzu-night/92">
      <div className="mx-auto grid max-w-[1520px] gap-4 px-5 py-10 sm:grid-cols-2 lg:grid-cols-6 lg:px-10">
        {benefits.map((benefit) => {
          const Icon = benefit.icon;

          return (
            <div key={benefit.title} className="flex items-start gap-4 border-yuzu-line/55 py-2 lg:border-r lg:pr-5 last:lg:border-r-0">
